...
public class NativeCaller {
	...
	public native static int TransferMessage(String did, String msg, int len);//姝ゆ帴鍙ｅ彲浠ラ�忎紶鎵�鏈夌殑CGI鎸囦护
	
	public native static void PPPPInitialOther(String svr);//鍒濆鍖栧叾浠栨湇鍔″櫒
