package com.yh.materialdesign.dialog;

import com.yh.materialdesign.R;
...
public class MaterialDialog {
	 ...
	 * 点击返回键是否能返回
	 */
	private boolean mCancelByBackKey;
	...
	public void setCancelable(boolean isCanCancel) {
		...
		this.mCancelByBackKey = isCanCancel;
		if (mBuilder != null) {
			mBuilder.setCancelable(mCancelByBackKey);;
		}
	}
	...
	private class Builder {
		...
		private Builder() {
			...
			mAlertDialog.setCancelable(mCancelByBackKey);
		...
		public void setCancelable(boolean isCanCancel) {
			mAlertDialog.setCancelable(isCanCancel);
		}
	}
}