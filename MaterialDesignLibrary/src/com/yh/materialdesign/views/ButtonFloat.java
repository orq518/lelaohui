package com.yh.materialdesign.views;
...
public class ButtonFloat extends Button {
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		boolean animate = attrs.getAttributeBooleanValue(MATERIALDESIGNXML,
				"animate", false);
		if (animate) {
			post(new Runnable() {
				...
				public void run() {
					...
					ViewHelper
							.setY(ButtonFloat.this,
									ViewHelper.getY(ButtonFloat.this)
											+ getHeight() * 3);
					ObjectAnimator animator = ObjectAnimator.ofFloat(
							ButtonFloat.this, "y", originalY);
